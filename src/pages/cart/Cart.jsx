...
function Cart() {
  ...
  const buyNow = async () => {
    ...
    var options = {
      ...
      // put your razerpay key key_id,key_secret rzp_test_yxgXOYbrtTG84C,H7mnCr8Rbf3mF9B7fxLsHzJ7

      
      key: "rzp_test_yxgXOYbrtTG84C",
      key_secret: "H7mnCr8Rbf3mF9B7fxLsHzJ7",
      ...
      handler: function (response) {
        ...
        toast.success('Payment Successful',{ position: "top-center",autoClose: 1000,})
        ...
        return () => clearTimeout(timer);
          ...
          console.log(error)
          toast.error('Payment Failed',{ position: "top-center",autoClose: 1000,})
        }
      },
